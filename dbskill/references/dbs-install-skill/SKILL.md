...
本机通过 `dbskill` 单入口调用时，脚本位置是 `<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh`；不要把本模块复制或注册成独立 Skill。
...
```bash
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh link <skill-name-or-path>
```

示例：

```bash
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh link dbs-hook
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh link skills/my-custom-skill
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh link skills
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh link "/absolute/path/to/skill"
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh link "/Users/me/external-skills"
```
...
```bash
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh status <skill-name-or-path>
```
...
```bash
<dbskill 目录>/references/dbs-install-skill/scripts/install-skill.sh unlink <skill-name-or-path>
```
