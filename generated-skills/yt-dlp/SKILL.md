---
name: yt-dlp
description: GitHub-derived skill for yt-dlp. Use when the user asks to run, wrap, or automate this repository's workflow.
metadata:
  source:
    github_url: https://github.com/yt-dlp/yt-dlp
    github_hash: unknown
    version: 0.1.0
    created_at: 2026-02-27T05:51:29.884320+00:00
    default_branch: main
    stars: None
    license: None
